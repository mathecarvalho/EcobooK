            ...
            <form @submit.prevent="salvarLivro">
                ...
                <div class="mt-4 d-flex justify-content-end">
                    <button type="submit" class="btn btn-dark btn-lg">
                        <i class="bi bi-save me-2"></i> Atualizar Livro
                    </button>
                </div>
            </form>
        </div>
...
const form = reactive<Produto>({
    ...
    numeroPaginas: 576,
    sinopse: 'A história da jornada de Frodo e a Sociedade do Anel para destruir o Um Anel.',
    dimensoes: { altura: 23, largura: 16, profundidade: 4, peso: 0.8 },
    grupoPrecificacao: 'Premium',
...
function salvarLivro() {
    console.log("Livro atualizado:", { ...form })
